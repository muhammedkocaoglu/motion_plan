...
initial_position_.x = -4
initial_position_.y = -6
initial_position_.z = 0
desired_position_ = Point()
desired_position_.x = 6
...
def main():
    ...
    sub_odom = rospy.Subscriber('/hamer/odom', Odometry, clbk_odom)
    ...
    while not rospy.is_shutdown():
        ...
        if state_ == 0:
            if regions_['front'] > 0.1 and regions_['front'] < 0.5:
                change_state(1)
